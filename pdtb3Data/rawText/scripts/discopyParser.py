...
from utils import get_all_files, writelines, foldercheckerJson
...
if __name__ == '__main__':
    ...
    # print(folder_names)
    englishDiscopyParsedPath = "/local/musaeed/NaijaDiscourseClassification/pdtb3Data/rawText/englishDiscopyParsed"
    ...
    for folder_path in folder_names:  
        ...
        for file_path in file_paths:
            ...
            jsonFilePath = foldercheckerJson(englishDiscopyParsedPath, folder_list)

            # print(f"file name is {jsonFilePath}")
            output = []
            for sentence in english_non_empty_lines:
